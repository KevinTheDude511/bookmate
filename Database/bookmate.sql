...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2023 at 12:14 PM
...
INSERT INTO `genre` (`genreID`, `bookGenre`) VALUES
(1, 'Ngôn tình'),
(2, 'Phiêu lưu'),
(3, 'Thiếu nhi'),
(4, 'Toán học'),
...
(1, 'Khuong', '202cb962ac59075b964b07152d234b70', 'd.khuong0511@gmail.com'),
(3, 'Sky', 'c4ca4238a0b923820dcc509a6f75849b', 'nguyendinhthienhuy@gmail.com');
...
--
ALTER TABLE `book`
  ADD CONSTRAINT `book_ibfk_1` FOREIGN KEY (`genreID`) REFERENCES `genre` (`genreID`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
